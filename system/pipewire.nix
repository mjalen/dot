		    ...
		    "context.modules" = [
			{
				...
				"filter.graph" = {
					...
					}
					{
					    ...
					    "config" = {
						"filename" = [
						    "/persist/home/jalen/Documents/gpd-pocket-4-pipewire/pipewire.conf.d/gpd-pocket-4-mp-48k-l.wav"
						];
						"channel" = 0;
						"gain" = 1.0;
					    };
					}
					{
					    ...
					    "config" = {
						"filename" = [
						    "/persist/home/jalen/Documents/gpd-pocket-4-pipewire/pipewire.conf.d/gpd-pocket-4-mp-48k-r.wav"
						];
						"channel" = 0;
						"gain" = 1.0;
					    };
